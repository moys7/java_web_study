	...
	<script>
		...
		*/
		...
		/*
			...
			$().action1().action2()...처럼 chain 형테의 동작은 가능할떄도 있고 아닐떄도 있다.
		...
		*/
		...
		//id가 two인 요소의 innerText를 여러분의, 이름, 글자크기 20px, 배경색 yellow
		$("#two").text("모").css("font-size","20px").css("background-color", "yellow");
		...
		*/
		$("#sendBtn").on("click",function){
			//아이디가 inputMsg 인 곳에 입력한 값을 읽어와서 상수 msg에 담는다.
