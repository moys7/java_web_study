...
<body>
   <div class="container">
      ...
      <form action="signup.jsp" method="post" id="signupForm">
         ...
         <div>
            ...
            <small class="valid-feedback">특수문자를 하나 이상 조합하세요.</small>
   ...
   <script>
      ...
      document.querySelector("#email").addEventListener("input", function(){
         ...
         //const reg=new RefExp("[a-z0-9]+@[a-z]+\\.[a-z]{2,3}")//문자열 작성시 \가 \\2개필요
      ...
      document.querySelector("#signupForm").addEventListner("submit",function(event){
